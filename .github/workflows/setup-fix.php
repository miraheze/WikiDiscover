 ...
 * RESULTING IN "LogicException: ChronologyProtector already initialized". THIS HACK REMOVES THE
 * MediaWikiServices::getInstance()->getDBLoadBalancerFactory()->setRequestInfo FROM HERE.  THIS IS ALREADY FIXED FOR REL1_37 AND LATER.
